	...
	<div class="flex h-full flex-col gap-4 overflow-y-auto p-6">
		...
		{:else if selectedInfo}
			<div in:fade={{ duration: 200, delay: 50 }}>
				...
				<section
					class="read-panel mt-3 overflow-auto rounded-xl border border-darkCyan bg-gradient-to-b from-black/[0.02] to-white/[0.01] p-3 shadow-[0_8px_30px] shadow-cyan-400/[0.02]"
					aria-live="polite"
				>
					<div class="pr-1">
